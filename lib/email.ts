              ...
              <table role="presentation" style="width: 600px; max-width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <tr>
                  <td style="padding: 40px 40px 30px 40px; text-align: center;">
                    <h1 style="margin: 0 0 20px 0; font-size: 24px; font-weight: 600; color: #000000; line-height: 1.3;">Verify Your Email</h1>
                    <p style="margin: 0 auto 20px auto; font-size: 16px; line-height: 1.6; color: #333333; max-width: 70%;">Click below to verify your email address. This link will expire in 1 hour.</p>

                    <!-- CTA Button -->
                    <table role="presentation" style="margin: 30px auto;">
                      <tr>
                        <td>
                          <a href="${url}" style="display: inline-block; padding: 14px 32px; background-color: #000000; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; letter-spacing: 0.3px;">Verify Email</a>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="padding: 30px 40px; background-color: #f9f9f9; border-top: 1px solid #e5e5e5; text-align: center;">
                    ...
                    <p style="margin: 15px 0 0 0; font-size: 13px; line-height: 1.6; color: #999999;">&copy; ${new Date().getFullYear()} Bulletproof Fitness Equipment. All rights reserved.</p>
                  </td>
                </tr>
              </table>
            </td>

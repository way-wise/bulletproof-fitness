...
import { seedData } from "./ExCardsSection";
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-6 py-14 font-sans text-[17px] leading-relaxed text-[#222]">
      ...
      <div className="grid items-start gap-10 md:grid-cols-2">
        ...
        <div className="space-y-5">
          ...
          <ul className="space-y-1.5 text-[16px]">
            <li>
              <strong>Body Part:</strong> {data?.category}
            </li>
            <li>
              <strong>Equipment Used:</strong> {data?.equipment}
            </li>
            <li>
              <strong>User Height In Inches:</strong> 63
            </li>
            <li>
              <strong>Rack Used:</strong> Other
            </li>
            <li>
      ...
      <div className="mt-16 text-center">
        ...
        <button className="mt-5 rounded bg-black px-5 py-3 text-base text-white hover:bg-gray-900">
